...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus at lorem ut erat aliquet tincidunt. Fusce a turpis non est ultrices tincidunt. Curabitur luctus, est sed porta accumsan, eros nunc tempor felis, in blandit risus lectus et odio.

### Small observations

- *Pellentesque* habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
- Integer sed egestas quam, sed eget lorem semper.
- Sed eget lorem semper, commodo mi ac, luctus risus.
...
Here is a tiny inline `code` sample and a soft emphasis: _donec vitae_. See the margin note[^long].
